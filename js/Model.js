...
function getNode() {
  ...
  $.ajax({
    ...
    success: function (response) {
      allDataSqlString = response;
      var newAllDataString =
        ' {"nodes": [ ' + allDataSqlString.slice(0, -1) + '], "links": [] }';
      // //console.log(newAllDataString);

      data = JSON.parse(newAllDataString);
...
("download");
  ...
  function getGradID(link) {
    //console.log("linkGrad-" + link.source + link.target);
