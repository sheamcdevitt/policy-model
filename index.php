...
<head>
 ...
 <!-- <!-- !Used for tabs but interferes with searchbox format 
  ...
  <link href="https://fonts.googleapis.com/css?family=Oswald|Oswald+Light|Saira+Extra+Light|Saira+Semi+Bolf" rel="stylesheet"> 
...
<body>
  <div class="jumbotron" style="margin-bottom: 0;">
    <div class="container">
      ...
      <p class="h5">The aim of the USI Policy Tool is to provide instant and coherent access to multiple outcomes and
        indicators from international to local level policy to understand how they might link and influence projects.
        Simply insert keywords or themes that apply to your project and select the relevant objectives you wish to align
        to or meet.</p>
      ...
      <ul class="list-unstyled">
        <li class="media">
          ...
          <div class="media-body">
            ...
            One of the key issues surrounding government departments and city councils is the ability for civil servants
            to see a co-ordinated approach across strategies and live projects to promote learning and
            cross-departmental alignment for better collaboration. This tool provides a visual mind map to support that
            challenge.
          </div>
        </li>
        <li class="media my-4">
          ...
          <div class="media-body">
            ...
            As well as mapping to other projects and strategies, the user can input their project onto the database for
            future use; meaning other departments and teams that are using the tool can understand how their project
        ...
        <li class="media">
          ...
          <div class="media-body">
            ...
            Beyond the visual map the user can also use the implementation table to identify KPIs alongside the matched
            outcomes and indicators. The implementation table learns and as such the user has the ability to see how
        ...
        <li class="media mt-4">
          ...
          <div class="media-body">
            ...
            The next stage of the tools' development is for users to input if the KPIs were achieved post completion,
            building an evidence base into the tool for best practice and rational for future project justification.
            This tool provides a secure space in which the civil service no longer has to create core components of
            business cases and strategies in silo, it learns, it builds and it is instant, providing a visual mind map
            of all polices and strategic projects within the public sector.
          </div>
        </li>
      </ul>
      <h5 class="mt-5 mb-1">As well as seeing what other departments are prioritising to promote cross-departmental
        collaboration it offers an opportunity to standardise and create living core components required for NIGEIE
        compliant documents, namely:</h5>
      <ul class="list-group mt-4">
        <li class="list-group-item"><i class="fas fa-check-circle fa-lg mr-4"></i>Intuitive Strategic fit, (need and
          demand) mapping</li>
        <li class="list-group-item"><i class="fas fa-check-circle fa-lg mr-4"></i>Live SMART objectives</li>
        <li class="list-group-item"><i class="fas fa-check-circle fa-lg mr-4"></i>A better understanding of potential
          for displacement (see all projects across departments)</li>
        <li class="list-group-item"><i class="fas fa-check-circle fa-lg mr-4"></i>Stronger chance of cross-departmental
          collaboration, (see what others are trying to achieve through the database)</li>
        <li class="list-group-item"><i class="fas fa-check-circle fa-lg mr-4"></i>Provides an intuitive post project
  ...
  -->
  <!--BUTTONS: should loop and create these but will do for now-->
  <form class="white" action="php/add.php" method="POST">
  <section class="jumbotron" style="margin-top: 0; margin-bottom: 0;">
  <div class="container">
    <div class=" row">
      <div class="col-md-7">
        <h1 style="text-align: left;">Project Info</h2>
          <br>
          <div class="boxInfo">
            <div class="input-group input-group-lg">
              <input type="text" name="projectName" id="projectName" placeholder="Project Name" class="form-control" value="<?php echo htmlspecialchars($projectName) ?>"/> 
              <div class="red-text"><?php echo $errors['projectName']; ?></div>
            </div>
          </div>
          <div class="boxInfo">
            <div class="input-group input-group-lg">
              <input type="text" name="projectValue" id="projectValue" placeholder="Project Value (£)" class="form-control" value="<?php echo htmlspecialchars($projectValue) ?>"/>
            </div>
          </div>
          <div class="boxInfo">
            <div class="input-group input-group-lg">
              <input type="text" name="projectDeliveryDate" id="projectDeliveryDate" placeholder="Delivery Date" class="form-control" value="<?php echo htmlspecialchars($projectDeliveryDate) ?>"/>
            </div>
          </div>
          <div class="boxInfo">
            <div class="input-group input-group-lg">
              <input type="text" name="projectLocation" id="projectLocation" placeholder="Location" class="form-control"/>
            </div>
          </div>
          <div class="boxInfo">
            <div class="input-group input-group-lg">
              <input type="text" name="projectDeliveryPartners" id="projectDeliveryPartners" placeholder="Delivery Partners" class="form-control"/>
            </div>            
          </div>
          <br/>  
      </div>
  ...
  <section class="jumbotron" style="margin-top: 0;">
    <div class="container">
      <div class=" row">
        <div class="col-md-7">
          <h1 style="text-align: left;">Search Policies</h2>
            <br>
            <div class="boxSearch">
              <div class="input-group input-group-lg">
                <input type="text" name="search" id="search" placeholder="Search Policies" class="form-control"/>
                <span class="input-group-append">
                  <button id="CreateModel" class="btn btn-primary">
                    <span aria-hidden="true"></span>Create Model</button>
                </span>
              </div>
            </div>
...
<!-- Tab code: can be used to Tab between Model, Table, and Model Descriptions maybe--->
  <div class="tabbable">
    <ul class="nav nav-tabs">
        <li class="active"><a class="atab" href="#a_tab" data-toggle="tab">Model</a></li>
        <li><a class="btab" href="#b_tab" data-toggle="tab">Descriptions</a></li>
        <li><a class="ctab" href="#modelMap" data-toggle="tab">Map</a></li>
    </ul>
    <div class="tab-content">
       ...
       <!-- <div class="tab-pane" id="c_tab" style="width: 600px; height: 400px;">
          <h1>Map</h1>
          <ccontent></ccontent>
      </div>-->
...
<button class="btn btn-primary" id="download-png" <span aria-hidden="true"></span>Download Image</button>
<button class="btn btn-primary" id="download-svg" <span aria-hidden="true"></span>Download Vector</button>
<button class="btn btn-primary" name="save-project" id="save-project" <span aria-hidden="true"></span>Save Project</button>
